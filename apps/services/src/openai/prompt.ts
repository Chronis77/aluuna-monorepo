  ...
  try {
    ...
    return {
      ...
      toolPolicy: [
        ...
        '- Important people in their life → storeRelationship',
        '- Inner parts/voices ("There\'s this part of me...") → storeInnerPart',
        '- Personal breakthroughs or achievements → storeGrowthMilestone',
        '- Free-form journaling or reflection → logFreeJournalEntry',
        '- Core values and what matters most → setValuesCompass',        
