...
const VERCEL_URL = 'https://aluuna-tts.vercel.app';
const API_KEY = process.env.API_KEY || 'your-api-key-here'; // Set via environment variable or replace manually
...
async function testVercelDeployment() {
  ...
  try {
    ...
    console.log('   2. Replace the API_KEY with your production API key');
